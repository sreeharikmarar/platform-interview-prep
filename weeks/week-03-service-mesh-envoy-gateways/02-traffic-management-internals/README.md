...
- **consecutive_gateway_errors**: Number of consecutive upstream responses that are gateway-level failures (502, 503, 504) before ejection. Distinct from `consecutive_5xx` because these specifically indicate the upstream gateway failed, not the application. Default 5.
