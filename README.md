# Platform Interview Prep — 4 Weeks

A structured, hands-on curriculum for senior/staff platform engineer and infrastructure interviews. Covers Kubernetes internals, operator patterns, Envoy and service mesh, and distributed systems at scale.
...
This repo is a 4-week study plan that builds that depth systematically. Each topic pairs deep conceptual understanding with runnable labs and rehearsed talk tracks so you can both *understand* and *articulate* the material under interview pressure.

## What's inside

Each of the 20 topics follows a consistent format:
